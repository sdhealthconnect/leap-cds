...
const ACTIVE_PRIVACY_CONSENT_WITH_SCOPE_IN_CATEGORY = require("../fixtures/consents/r5/consent-boris-optin-with-scope-in-category.json");
...
const ACTIVE_RESEARCH_CONSENT = require("../fixtures/consents/r5/consent-boris-research.json");
const ACTIVE_PRIVACY_OPTOUT_CONSENT = require("../fixtures/consents/r5/consent-boris-optout.json");
const ACTIVE_PRIVACY_CONSENT_WITH_SEC_LABEL_PROVISION = require("../fixtures/consents/r5/consent-boris-deny-restricted-label.json");
const ACTIVE_PRIVACY_CONSENT_WITH_MULTIPLE_SEC_LABEL_PROVISION = require("../fixtures/consents/r5/consent-boris-multiple-deny-labels.json");
const ACTIVE_PRIVACY_CONSENT_WITH_PROVISION_ARRAY = require("../fixtures/consents/r5/consent-boris-provision-array.json");
const ACTIVE_PRIVACY_CONSENT_WITH_POU = require("../fixtures/consents/r5/consent-boris-optin-with-pou.json");
...
it("active optin consent with blacklisted purpose of use", async () => {
  ...
  _.unset(CONSENT_WITH_POU_PROVISION, "provision[0].actor");
  _.set(CONSENT_WITH_POU_PROVISION, "provision[0].purpose", [
    {
...
it("active optin consent with content class provisions and sec label with request including a class", async () => {
  expect.assertions(2);
  const ACTIVE_PRIVACY_CONSENT_WITH_CONTENT_CLASS_PROVISION_AND_SEC_LABEL = require("../fixtures/consents/r5/consent-boris-deny-restricted-content-class-and-sec-label");
...
it("active optin consent with content class provisions with request including a class", async () => {
  expect.assertions(2);
  const ACTIVE_PRIVACY_CONSENT_WITH_CONTENT_CLASS_PROVISION = require("../fixtures/consents/r5/consent-boris-deny-restricted-content-class-only.json");
