...
| `purposeOfUse`             | An array of purposes of use in the workflow context. These should be in the form of an array of string values (only codes without the code system; see example below) from the [FHIR Purpose of Use valueset](https://www.hl7.org/fhir/v3/PurposeOfUse/vs.html). Rules matching _any_ of the values in this array will be considered in making the consent decision.              | 
